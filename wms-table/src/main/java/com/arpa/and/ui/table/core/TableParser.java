...
import com.arpa.and.ui.table.data.ArrayStructure;
...
import com.arpa.and.ui.table.data.column.ColumnNode;
import com.arpa.and.ui.table.data.table.ArrayTableData;
            ...
            for (Column child : childColumns) {
                if (child instanceof ArrayColumn) {
                    ...
                    if (structure.getCellSizes() == null) {
                        structure.setCellSizes(new ArrayList<>());
                    } else {
