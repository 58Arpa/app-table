...
import com.arpa.and.ui.table.data.Cell;
...
import com.arpa.and.ui.table.data.column.ColumnInfo;
import com.arpa.and.ui.table.data.format.sequence.ISequenceFormat;
import com.arpa.and.ui.table.data.format.sequence.LetterSequenceFormat;
import com.arpa.and.ui.table.data.format.sequence.NumberSequenceFormat;
import com.arpa.and.ui.table.data.format.title.ITitleDrawFormat;
import com.arpa.and.ui.table.data.format.title.TitleDrawFormat;
...
public class TableData <T> {
    ...
    public void setOnItemClickListener(final OnItemClickListener onItemClickListener) {
        ...
        for (Column column : columns) {
            if (!column.isParent()) {
                column.setOnColumnItemClickListener((column1, value, t, position) -> {
                    if (onItemClickListener != null) {
                        int index = childColumns.indexOf(column1);
                        TableData.this.onItemClickListener.onClick(column1, value, t, index, position);
                    }
                });
            }
        }
    ...
    public void setOnColumnClickListener(final OnColumnClickListener onColumnClickListener) {
        ...
        if (this.onRowClickListener != null) {
            setOnItemClickListener((column, value, o, col, row) -> TableData.this.onColumnClickListener.onClick(column, column.getDatas(), col, row));
        }
    }
    ...
    public void setOnRowClickListener(final OnRowClickListener<T> onRowClickListener) {
        ...
        if (this.onRowClickListener != null) {
            setOnItemClickListener((column, value, o, col, row) -> TableData.this.onRowClickListener.onClick(column, t.get(row), col, row));
        }
    }
