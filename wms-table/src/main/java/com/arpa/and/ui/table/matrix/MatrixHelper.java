...
import com.arpa.and.ui.table.listener.Observable;
...
public class MatrixHelper extends Observable<TableClickObserver> implements ITouch, ScaleGestureDetector.OnScaleGestureListener {
    ...
    private final Rect originalRect; //原始大小
    ...
    private final PointEvaluator evaluator = new PointEvaluator();
    ...
    public void onDisallowInterceptEvent(View view, MotionEvent event) {
        ...
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            case MotionEvent.ACTION_DOWN:
                ...
                mDownY = event.getY();
                //判断是否落在图表内容区中
                parent.requestDisallowInterceptTouchEvent(originalRect.contains((int) mDownX, (int) mDownY));
