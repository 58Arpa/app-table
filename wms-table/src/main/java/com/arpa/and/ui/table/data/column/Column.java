...
import com.arpa.and.ui.table.data.format.count.DecimalCountFormat;
import com.arpa.and.ui.table.data.format.count.ICountFormat;
import com.arpa.and.ui.table.data.format.count.NumberCountFormat;
import com.arpa.and.ui.table.data.format.count.StringCountFormat;
import com.arpa.and.ui.table.data.format.draw.FastTextDrawFormat;
import com.arpa.and.ui.table.data.format.draw.IDrawFormat;
import com.arpa.and.ui.table.data.format.draw.MultiLineDrawFormat;
import com.arpa.and.ui.table.data.format.draw.TextDrawFormat;
import com.arpa.and.ui.table.listener.OnColumnItemClickListener;
...
public class Column <T> implements Comparable<Column> {
    ...
    public IDrawFormat<T> getDrawFormat() {
        if (drawFormat == null) {
            drawFormat = isFast ? new FastTextDrawFormat<>() : new TextDrawFormat<>();
        }
        return drawFormat;
    }
